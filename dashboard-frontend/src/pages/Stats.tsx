export default function Stats() {
  const stats = [
    ...
    { label: "Abgeschlossene Ziele", value: 45 },
  ];

  return (
    <div className="flex items-center justify-center h-full w-full">
      <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 text-white rounded-3xl shadow-2xl p-10 max-w-3xl w-[90%] text-center">
