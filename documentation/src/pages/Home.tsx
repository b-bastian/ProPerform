    ...
    <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] text-white select-none overflow-hidden">
      <div className="text-center space-y-6">
        <h1 className="text-5xl font-extrabold tracking-tight">
          Willkommen in der <span className="text-blue-500">ProPerform</span>{" "}
          <span className="text-blue-400">API&nbsp;Dokumentation</span>
        </h1>

        <p className="text-gray-400 max-w-xl mx-auto text-lg">
          Hier findest du alle verfügbaren Endpunkte für Benutzer- und
          Trainerfunktionen.
        </p>
